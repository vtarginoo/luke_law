...
public class BDSimulate {
    ...
    public BDSimulate() {
        ...
        processosAssociados.put("0809129-51.2024.8.19.0001", List.of(2));
        processosAssociados.put("0838717-06.2024.8.19.0001", List.of(2));
        processosAssociados.put("0907787-47.2023.8.19.0001", List.of(2));
        //processosAssociados.put("0947617-20.2023.8.19.0001", List.of(2));
        //processosAssociados.put("0938160-61.2023.8.19.0001", List.of(2));
